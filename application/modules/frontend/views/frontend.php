            ...
            <div class="row">
                <div class="col-12 col-md-6 col-lg-4">
                    <div class="card card-team">
                        <img class="card-img rounded-0" src="<?php  echo $this->config->item('tem_frontend_img'); ?>team/1.jpg" alt="">
                ...
                <div class="col-12 col-md-6 col-lg-4">
                    <div class="card card-team">
                        <img class="card-img rounded-0" src="<?php  echo $this->config->item('tem_frontend_img'); ?>team/2.jpg" alt="">
                        <div class="card-team__body text-center">
                ...
                <div class="col-12 col-md-6 col-lg-4">
                    <div class="card card-team">
                        <img class="card-img rounded-0" src="<?php  echo $this->config->item('tem_frontend_img'); ?>team/3.jpg" alt="">
                        <div class="card-team__body text-center">
                            <h3><a href="#">Dr Blian Judge</a></h3>
                            <p>Cardiologist</p>
                            <div class="team-footer d-flex justify-content-between">
                ...
                <div class="item">
                    <div class="testi_item">
                        <div class="testimonial_image">
                            <img src="<?php  echo $this->config->item('tem_frontend_img'); ?>elements/tes1.jpg" alt="">
                        </div>
            ...
            <div class="row">
                <div class="col-md-6 col-lg-4 col-md-4">
                    <div class="single-blog">
                        <div class="thumb">
                            <img class="img-fluid" src="<?php  echo $this->config->item('tem_frontend_img'); ?>blog/1.jpg" alt="">
                        </div>
                ...
                <div class="col-md-6 col-lg-4 col-md-4">
                    <div class="single-blog">
                        <div class="thumb">
                            <img class="img-fluid" src="<?php  echo $this->config->item('tem_frontend_img'); ?>blog/2.jpg" alt="">
                        </div>
                        <div class="short_details">
                            <div class="meta-top d-flex">
                                <a href="#">medical, </a>
                ...
                <div class="col-md-6 col-lg-4 col-md-4">
                    <div class="single-blog">
                        <div class="thumb">
                            <img class="img-fluid" src="<?php  echo $this->config->item('tem_frontend_img'); ?>blog/3.jpg" alt="">
                        </div>
                        <div class="short_details">
                            <div class="meta-top d-flex">
                                <a href="#">medical, </a>
